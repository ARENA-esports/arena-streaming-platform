    ...
    <div className="max-w-4xl mx-auto p-6 text-gray-200">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="bg-arena-surface border border-arena-border rounded-lg p-6 flex items-center gap-6">
            <div className="w-24 h-24 rounded-full bg-arena-cyan flex-shrink-0 overflow-hidden flex items-center justify-center text-black text-4xl font-bold">
              {formData.avatarUrl ? (
            ...
            <div className="flex-1 space-y-2">
              ...
              />
              <p className="text-sm text-arena-textMuted">Provide a valid image URL for your profile picture.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-4">Profile Banner</h2>
          <div className="bg-arena-surface border border-arena-border rounded-lg p-6">
            <div className="h-32 bg-arena-surfaceHover border border-arena-border rounded-md mb-4 overflow-hidden relative flex items-center justify-center">
              {formData.bannerUrl ? (
                <img src={formData.bannerUrl} alt="Banner" className="w-full h-full object-cover" />
              ) : (
                <span className="text-arena-textMuted">No banner provided</span>
              )}
            </div>
            <div className="space-y-2">
              <input 
                ...
                className="w-full bg-black border border-arena-border rounded px-4 py-2 focus:border-arena-cyanFocus outline-none"
              />
              <p className="text-sm text-arena-textMuted">File format: JPEG, PNG, GIF (recommended 1200x480, max 10MB)</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <form onSubmit={handleSubmit} className="bg-arena-surface border border-arena-border rounded-lg p-6 space-y-6">
            ...
            <div className="flex justify-end pt-4 border-t border-arena-border">
              <button 
                type="submit" 
                disabled={saving}
          ...
          <div className="bg-arena-surface border border-arena-border rounded-lg mb-8">
            <div className="flex flex-col sm:flex-row p-6 border-b border-arena-border hover:bg-arena-surfaceHover transition-colors">
              ...
              <div className="text-sm text-arena-textMuted">
                If you want to disable your Arena account, you can do so from the <a href="#" className="text-purple-400 hover:underline">Disable Account</a> page.
              </div>
            </div>
