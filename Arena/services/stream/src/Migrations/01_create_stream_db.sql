-- =============================================================================
-- Migration & Seed Script: arena_stream_db
-- Target Engine: MySQL 8.0+ (InnoDB, UTF8mb4)
-- Description: Complete schema definition and seed data for StreamService.
-- =============================================================================

CREATE DATABASE IF NOT EXISTS arena_stream_db
